...
"")
        ...
        self.txt_razao.setGeometry(QRect(120, 30, 201, 41))
...
"")
        ...
        self.txt_contato.setGeometry(QRect(80, 110, 131, 41))
...
"")
        ...
        self.txt_cnpj.textChanged.connect(self.buscaCnpj)
        self.txt_cnpj.setGeometry(QRect(390, 30, 121, 41))
...
"")
   ...
   # setupUi
    ...
    def buscaCnpj(self):
        validarCnpj = CNPJ() #54339989000191

        cnpj1 = self.txt_cnpj.text()
        if validarCnpj.validate(cnpj1):
                self.lbl_cpfT.setText("✅ CNPJ VÁLIDO")
                return
        else:
                self.lbl_cpfT.setText("❌ CNPJ INVÁLIDO")
                return
